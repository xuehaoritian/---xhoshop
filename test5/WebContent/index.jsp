	...
	<div class="header">
		<div class="header-top">
			...
			<div class="header-top-in">			
				<div class="logo">
					<a href="/test5/user/u"><img src="images/logo.png" alt=" " ></a>
				</div>
				<div class="header-in">
					<ul class="icon1 sub-icon1">
							<li  ><a href="wishlist.html">购物车 (0)</a> </li>
						  ...
						  <div class="shopping_cart">
                            ...
                            <div class="login_buttons">
							  <div class="check_button"><a href="checkout.html">去结算</a></div>
							  <div class="clearfix"></div>
						    </div>
					      <div class="clearfix"></div>
						</ul>
			...
			<div class="h_menu4">
				...
				<ul class="nav">
					...
					<li ><a href="#" >笔记本电脑</a>
						...
						<li><a href="products.html" >软件</a></li>
						<li><a href="products.html" >手机和pad </a></li>
			  ...
			  <li><img src="images/banner2.jpg" alt="">
				...
				<div class="banner-bottom">
					<div class="banner-matter">
						...
						<a href="single.html" class="hvr-shutter-in-vertical ">买买买</a>
					</div>
					<div class="purchase">
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								...
								<div class="top-content">
									...
									<div class="white">
										<a href="single.html" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">添加到购物车</a>
