	...
	<div class="header">
		...
		<div class="container">
			...
			<h2 class=" contact-in">联系</h2>
				...
				<div class="col-md-6 contact-top">
					<h3>以下是您的个人信息，如果想要修改直接修改完提交即可</h3>
						<form action="/test5/user/modifyInformation">
						<div>
							<span>姓名 </span>		
							<input type="text" value="${loginingUser.userName }" name="userName">						
						</div>
						<div>
							<span>e-mail </span>		
							<input type="text" value="${loginingUser.mailAddress }" name="mailAddress">						
						</div>
						<div>
							<span>密码</span>		
							<input type="text" value="${loginingUser.password }" name="password">	
						</div>
						<div>
							<span>收货人信息</span>		
							<textarea name="personalProfile">${loginingUser.personalProfile } </textarea>	
						</div>
