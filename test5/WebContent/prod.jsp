...
<body>
 <!--header-->
	<div class="header">
		...
		<div class="container">
			<div class="contact">
			<h2 class=" contact-in">联系</h2>
				
				<div class="col-md-6 contact-top">
					<h3>信息</h3>
					<div class="map">
						<img alt="" src="/test5/images/pi1.jpg">
					</div>
				...
				<div class="col-md-6 contact-top">
					<h3>以下是产品，如果想要修改直接修改完提交即可</h3>
						<form action="/test5/administrator/productAction">
						<div>
							<span>产品名称 </span>		
							<input type="text" value="${updateProduct.productName }" name="productName">						
						</div>
						<div>
							<span>产品介绍 </span>		
							<input type="text" value="${updateProduct.productDescription }" name="productDescription">						
						</div>
						<div>
							<span>产品价格</span>		
						...
						<div>
							<span>图片地址</span>		
							<input type="text" value="${updateProduct.imgAddress }" name="imgAddress">	
						</div>
						<div>
							<span>上架时间</span>		
							<input type="text" value="${updateProduct.shelfTime }" name="shelfTime">	
						</div>
						<div>
							<span>产品类型</span>		
							<input type="text" value="${updateProduct.type }" name="type">	
						</div>
