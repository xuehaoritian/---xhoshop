...
<body>
  <!--header-->
	<div class="header">
		...
		<div class="container">
			<div class="products">
					<h2 class=" products-in">产品</h2>
					<div class=" top-products">
					
					<c:forEach items="${keyProductList }" var="p">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/test5/single.jsp" class="compare-in"><img  src="${p.imgAddress }" alt="" />
								<div class="compare">
									<span>查看详情</span>
								</div>
								</a>	
								<div class="top-content">
									<h5><a href="/test5/single.jsp">${p.productName }</a></h5>
									<div class="white">
										<a href="/test5/cart/addToCart?productId=${p.productId }" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">添加到购物车</a>
										<p class="dollar"><span class="in-dollar">$</span><span>${p.price }</span></p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
